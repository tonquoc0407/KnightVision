# Pre-Game Opening Outcome Model Card

## Summary

Three-class XGBoost classifier for normalized game outcome. This variant uses only pre-game features and is the honest prediction case.
